...
class JsonRPC:
    ...
    def ethGetProof(self, addr, key=[], tag="latest"):
    ...
    def ethGetStorageAt(self, sto, pos, tag="latest"):
        # return the the value stored at the pos
...
#.\geth --datadir "./account" init ./genesis/genesis.json
#  ./geth  --rpc --rpcport 8545 --datadir "./data" --port 30399 --verbosity 1 --rpcapi "eth,web3,personal,net, tx_pool, admin, miner" console